...
class ConsoleInFile:
    ...
    def __init__(self, film_service: FilmServiceInFile, client_service: ClientServiceInFile):
    ...
    def ui_ichiriaza_film(self):
        ...
        self.client_service.inchiriere(id_client, id_film)
    ...
    def ui_returneaza_film(self):
        ...
        self.client_service.returnare(id_client, id_film)
